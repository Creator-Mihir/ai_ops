    ...
    const handleSignup = async (e) => {
        ...
        try {
            const res = await fetch("http://localhost:3005/api/auth/signup", {
                ...
                body: JSON.stringify({ name, email, password }), // Sending password now
            });
            ...
            <div className="relative hidden h-screen w-1/2 overflow-hidden bg-zinc-900 md:flex xl:w-[60%]">
                ...
                <div className="relative z-10 flex h-full flex-col justify-end p-16 text-white xl:p-24">
                    ...
                    <p className="mt-6 max-w-xl text-lg text-zinc-300 leading-relaxed">
                        Join thousands of engineers using AutoOpsGPT to streamline deployment, monitoring, and scaling.
                    </p>
                    <div className="mt-8 flex gap-x-4">
                        <div className="text-sm text-zinc-400">Enterprise grade security. SOC2 Compliant.</div>
                    </div>
                </div>
            </div>
        </div>
