...
const platforms = [
  ...
  { 
    ...
    icon: <path d="M12 24C18.6 24 24 18.6 24 12C24 5.4 18.6 0 12 0C5.4 0 0 5.4 0 12C0 18.6 5.4 24 12 24Z" />, // Simplified circle for GCP
  ...
  { 
    ...
    icon: <path d="M13.98 9.38l-2.3 2.3-2.3-2.3 2.3-2.3 2.3 2.3zm-6.9 0l-2.3 2.3-2.3-2.3 2.3-2.3 2.3 2.3zm18.4 0l-2.3 2.3-2.3-2.3 2.3-2.3 2.3 2.3zm-6.9 0l-2.3 2.3-2.3-2.3 2.3-2.3 2.3 2.3z" />, // Simplified grid
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-zinc-950 px-4 py-12 font-sans text-zinc-200">
      ...
      <div className="w-full max-w-4xl space-y-10">
        ...
        {/* Configuration Panel (Reveals on Select) */}
        {selected && (
